// API Configuration with OpenRouter - TypeScript Version
...
export const validateAPIKeys = () => {
  ...
  const requiredKey = (API_CONFIG as any)[provider]?.apiKey;
...
export const getAPIConfig = (provider: string | null = null) => {
  const selectedProvider = provider || API_CONFIG.AI_PROVIDER;
  return {
    ...(API_CONFIG as any)[selectedProvider],
