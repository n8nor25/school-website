  ...
  try {
    ...
    const material = await db.educationalMaterial.update({
      ...
      data: {
        ...
        ...(body.subjectId !== undefined && { subjectId: (body.subjectId && body.subjectId !== 'none') ? body.subjectId : null }),
        ...(body.classRoomId !== undefined && { classRoomId: (body.classRoomId && body.classRoomId !== 'none') ? body.classRoomId : null }),
